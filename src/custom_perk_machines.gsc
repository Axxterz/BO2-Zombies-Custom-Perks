...
init_custom_map()
{
	if( getdvar( "mapname" ) == "zm_transit" && getdvar( "g_gametype" ) == "zstandard")
	{
		...
		//Laundry Door
		perk_system( "script_model", (1851, -810, -55), "zombie_vending_jugg_on", ( 0, 180, 0 ), "custom", "mus_perks_sleight_sting", "Rampage", 4000, "jugger_light", "Rampage","zombie_perk_bottle_jugg" );
		...
		//North Town wall
		perk_system( "script_model", (1131, 613, -50), "zombie_vending_sleight_on", ( 0, 90, 0 ), "custom", "mus_perks_sleight_sting", "Guarding Strike", 4000, "sleight_light", "Guarding_Strike","zombie_perk_bottle_sleight" );
		//Bar Ground door
		...
		//next to EC
		perk_system( "script_model", (2442, -771, -55), "zombie_vending_marathon_on", ( 0, 215, 0 ), "custom", "mus_perks_sleight_sting", "Ammo Regen", 2000, "marathon_light", "Ammo_Regen","zombie_perk_bottle_marathon" );
		//Bank
		perk_system( "script_model", (795, 426, -40), "zombie_vending_marathon_on", ( 0, 90, 0 ), "custom", "mus_perks_sleight_sting", "Executioner's Edge", 5000, "marathon_light", "Executioners_Edge","zombie_perk_bottle_marathon" );
		//Bookstore stairs
		...
		perk_system( "script_model", (843, -1475, -45), "zombie_vending_marathon_on", ( 0, 90, 0 ), "custom", "mus_perks_sleight_sting", "Headshot Mayhem", 3000, "marathon_light", "Headshot_Mayhem","zombie_perk_bottle_marathon" );
		//next to tombstone
		...
		perk_system( "script_model", (8735, -6559, 108), "zombie_vending_jugg_on", ( 0, 210, 0 ), "custom", "mus_perks_sleight_sting", "Rampage", 4000, "jugger_light", "Rampage","zombie_perk_bottle_jugg" );
		//next to mystery box
		...
		//next to dbtp2
		perk_system( "script_model", (8366, -4691, 264), "zombie_vending_sleight_on", ( 0, 276, 0 ), "custom", "mus_perks_sleight_sting", "Guarding Strike", 4000, "sleight_light", "Guarding_Strike","zombie_perk_bottle_sleight" );
		//inside house
		...
		//right of fence
		perk_system( "script_model", (7204, -5824, -46), "zombie_vending_marathon_on", ( 0, 180, 0 ), "custom", "mus_perks_sleight_sting", "Executioner's Edge", 5000, "marathon_light", "Executioners_Edge","zombie_perk_bottle_marathon" );
		//nxt to tractor
	...
	else if (getdvar("mapname") == "zm_buried")
	{
		...
		perk_system( "script_model", (572, -375, 144), "zombie_vending_doubletap2_on", ( 0, 180, 0 ), "custom", "mus_perks_sleight_sting", "Rampage", 4000, "doubletap_light", "Rampage","zombie_perk_bottle_doubletap" );
		...
		//general store
		perk_system( "script_model", (80, -428, 144), "zombie_vending_jugg_on", ( 0, 270, 0 ), "custom", "mus_perks_sleight_sting", "Guarding Strike", 4000, "sleight_light", "Guarding_Strike","zombie_perk_bottle_sleight" );
		...
		//church downstairs
		perk_system( "script_model", (1698, 2394, 40), "zombie_vending_marathon_on", ( 0, 340, 0 ), "custom", "mus_perks_sleight_sting", "Headshot Mayhem", 2000, "marathon_light", "Headshot_Mayhem","zombie_perk_bottle_marathon" );
		//bank
		perk_system( "script_model", (-494, -198, 20), "zombie_vending_marathon_on", ( 0, 90, 0 ), "custom", "mus_perks_sleight_sting", "Thunder Wall", 3000, "marathon_light", "THUNDER_WALL","zombie_perk_bottle_marathon" );
	}
	...
	{	
		...
		perk_system( "script_model", ( 1919, 697, -64 ), "zombie_vending_doubletap2_on", ( 0, 330, 0 ), "custom", "mus_perks_tombstone_sting", "Thunder Wall", 2500, "doubletap_light", "THUNDER_WALL","zombie_perk_bottle_doubletap" );
		perk_system( "script_model", ( 701, 358, 80	 ), "zombie_vending_doubletap2_on", ( 0, 20, 0 ), "custom", "mus_perks_doubletap_sting", "Ammo Regen", 2500, "doubletap_light", "Ammo_Regen","zombie_perk_bottle_doubletap" );
		perk_system( "script_model", ( -998, 211, -34 ), "zombie_vending_revive_on", ( 0, 250, 0 ), "custom", "mus_perks_tombstone_sting", "Dying Wish", 3500, "revive_light", "Dying_Wish","zombie_perk_bottle_revive" );
		...
		perk_system( "script_model", ( -1830, 686, -48 ), "zombie_vending_doubletap2_on", ( 0, 340, 0 ), "custom", "mus_perks_tombstone_sting", "Executioner's Edge", 3000, "doubletap_light", "Executioners_Edge","zombie_perk_bottle_doubletap" );
		...
		perk_system( "script_model", ( -868, 352, 85 ), "zombie_vending_doubletap2_on", ( 0, 160, 0 ), "custom", "mus_perks_tombstone_sting", "Rampage", 2000, "doubletap_light", "Rampage", "zombie_perk_bottle_doubletap" );
		perk_system( "script_model", (-651, 273, -55), "zombie_vending_jugg_on", ( 0, 160, 0 ), "custom", "mus_perks_sleight_sting", "Guarding Strike", 3000, "sleight_light", "Guarding_Strike","zombie_perk_bottle_sleight" );
		...
		perk_system( "script_model", (-937, 275, -56 ), "zombie_vending_doubletap2_on", ( 0, 70, 0 ), "custom", "mus_perks_sleight_sting", "Headshot Mayhem", 2500, "marathon_light", "Headshot_Mayhem","zombie_perk_bottle_marathon" );
	}
	else if (getdvar( "mapname" ) == "zm_tomb") //Origins
	{
		...
		//excv site level 1
		perk_system( "script_model", (446, -144, -240), "zombie_vending_marathon_on", ( 0, 251, 0 ), "custom", "mus_perks_sleight_sting", "Rampage", 4000, "doubletap_light", "Rampage","zombie_perk_bottle_marathon" );
		//excv site
		perk_system( "script_model", (182, -108, -621), "zombie_vending_jugg_on", ( 0, 180, 0 ), "custom", "mus_perks_sleight_sting", "Guarding Strike", 3000, "sleight_light", "Guarding_Strike","zombie_perk_bottle_jugg" );
		//Gen 5 Cellar
		...
		perk_system( "script_model", (231, -409, -237), "zombie_vending_marathon_on", ( 0, 201, 0 ), "custom", "mus_perks_sleight_sting", "Executioner's Edge", 2000, "marathon_light", "Executioners_Edge","zombie_perk_bottle_marathon" );
		//staff station
		...
		//Gen 3 Bunker 1
		perk_system( "script_model", (2368, 3610, -292), "zombie_vending_marathon_on", ( 0, 270, 0 ), "custom", "mus_perks_sleight_sting", "Thunder Wall", 3000, "marathon_light", "THUNDER_WALL","zombie_perk_bottle_marathon" );
	}
	...
	{//Depot, Diner, Farm, Town, Power area
		...
		//Town bank
		perk_system( "script_model", (780, 90, -40), "zombie_vending_tombstone_on", ( 0, 90, 0 ), "custom", "mus_perks_sleight_sting", "Rampage", 3000, "jugger_light", "Rampage","zombie_perk_bottle_jugg" );
		...
		//Power Station
		perk_system( "script_model", (11572, 7723, -756), "zombie_vending_sleight_on", ( 0, 0, 0 ), "custom", "mus_perks_sleight_sting", "Guarding Strike", 3000, "sleight_light", "Guarding_Strike","zombie_perk_bottle_sleight" );
		//Farmhouse
		...
		perk_system( "script_model", (1832, -1220, -56), "zombie_vending_marathon_on", ( 0, 270, 0 ), "custom", "mus_perks_sleight_sting", "Thunder Wall", 2500, "marathon_light", "THUNDER_WALL","zombie_perk_bottle_marathon" );
		//outside bus depot
		perk_system( "script_model", (-7417, 4147, -64), "zombie_vending_doubletap2_on", ( 0, 180, 0 ), "custom", "mus_perks_sleight_sting", "Burn Heart", 2000, "doubletap_light", "Burn_Heart","zombie_perk_bottle_doubletap" );
